...
public class BarActivity extends FragmentActivity {
	...
	static RadioButton ra_base;// 基本界面
	static RadioButton ra_link;// 联动界面
	static RadioButton ra_op;// 账号界面
	static RadioButton ra_setting;// 设置界面
	private RadioButton[] rdo = new RadioButton[4];
	public static int view_get;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		DiyToast.showToast(getApplicationContext(), "当前IP："
