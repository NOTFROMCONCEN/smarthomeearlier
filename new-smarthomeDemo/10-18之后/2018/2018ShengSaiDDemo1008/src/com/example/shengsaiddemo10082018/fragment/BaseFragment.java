...
public class BaseFragment extends Fragment {
	...
	public static Button btn_send;// 红外发射按钮
	public static EditText et_send;// 红外发射文本框
	public static ToggleButton tg_lamp1, tg_lamp2, tg_door, tg_fan, tg_tv,
			tg_kongtiao, tg_dvd, tg_warm, tg_cur;// 开关
	public static EditText tv_temp;// 温度
	public static TextView tv_base_time;
	public static EditText tv_hum;// 湿度
	public static EditText tv_gas;// 燃气
	public static EditText tv_smo;// 烟雾
	public static EditText tv_ill;// 光照
	public static EditText tv_co;// Co2
	public static EditText tv_pm;// PM2.5
	public static EditText tv_per;// 人体红外
	public static EditText tv_press;// 气压
	...
	Handler handler = new Handler() {
		public void handleMessage(Message msg) {
			...
			tv_base_time.setText(TimeGetClass.Time);
