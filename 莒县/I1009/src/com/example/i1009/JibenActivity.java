...
public class JibenActivity extends Fragment {
	TextView tvtemp,tvhum,tvsmoke,tvill,tvpm25,tvco2,tvair,tvman,tvgas;
	ImageView imtemp,imhum;
	Matrix matrix;
	public static float temp,hum,smoke,ill,gas,co2,pm25,man,air;
				...
				getActivity().runOnUiThread(new Runnable() {
					...
					public void run() {
						...
						if (!TextUtils.isEmpty(bean.getIllumination())) {
							if (bean.getIllumination().equals("150")) {
								getActivity().finish();
							}else {
