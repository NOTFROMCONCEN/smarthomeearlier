...
public class JibenActivity extends Fragment {
	RelativeLayout jb;
	LinearLayout litemp,lihum,lismoke,ligas,lico2,lipm25,liair,liill,liman,litd1,litd2,litd3;
	ImageView imbjd,imlogo,imdoor,imfan,imlamp,imcllogo,imclk,imclg,imclt,imhw,imtd1,imtd2,imtd3,imtv,imdvd,imkt;
	public static float temp,hum,smoke,gas,ill,co2,pm25,air,man;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		imhw=(ImageView)view.findViewById(R.id.imhwlogo);
		...
		imbjd.setOnLongClickListener(longClickListener);
		imdoor.setOnLongClickListener(longClickListener);
		imfan.setOnLongClickListener(longClickListener);
		imlamp.setOnLongClickListener(longClickListener);
		imclk.setOnLongClickListener(longClickListener);
		imclt.setOnLongClickListener(longClickListener);
		imclg.setOnLongClickListener(longClickListener);
		
		litemp.setOnLongClickListener(longClickListener);
		lihum.setOnLongClickListener(longClickListener);
		lismoke.setOnLongClickListener(longClickListener);
		ligas.setOnLongClickListener(longClickListener);
		lico2.setOnLongClickListener(longClickListener);
		lipm25.setOnLongClickListener(longClickListener);
		liair.setOnLongClickListener(longClickListener);
		liman.setOnLongClickListener(longClickListener);
		liill.setOnLongClickListener(longClickListener);
		litd1.setOnLongClickListener(longClickListener);
		litd2.setOnLongClickListener(longClickListener);
		litd3.setOnLongClickListener(longClickListener);
		...
		imclk.setOnLongClickListener(new OnLongClickListener() {
			...
			public boolean onLongClick(View v) {
				// TODO Auto-generated method stub
				v.setOnTouchListener(tuozhuai);
				imcllogo.setImageResource(View.INVISIBLE);
				imhw.setImageResource(View.INVISIBLE);
				return false;
			}
		});
