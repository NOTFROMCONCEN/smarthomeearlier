		...
		chzdy.setOnCheckedChangeListener(new OnCheckedChangeListener() {
			...
			public void onCheckedChanged(CompoundButton buttonView,
				...
				if (etlian.getText().toString().isEmpty()) {
					Toast.makeText(ZhuActivity.this, "输入数据为空",
							Toast.LENGTH_LONG).show();
					chzdy.setChecked(false);
				} else if (!etlian.getText().toString().matches("[0-9]+")) {
					Toast.makeText(ZhuActivity.this, "输入数据有误",
							Toast.LENGTH_LONG).show();
					chzdy.setChecked(false);
				} else {
					...
					if (v1.equals("温度") && v2.equals(">") && temp > fazhi
							&& v3.equals("射灯打开")) {
						ControlUtils.control(ConstantUtil.Lamp,
								ConstantUtil.CHANNEL_ALL, ConstantUtil.OPEN);
					} else if (v1.equals("温度") && v2.equals(">")
							&& temp > fazhi && v3.equals("风扇打开")) {
						ControlUtils.control(ConstantUtil.Fan,
								ConstantUtil.CHANNEL_ALL, ConstantUtil.OPEN);
					} else if (v1.equals("温度") && v2.equals("<=")
							&& temp <= fazhi && v3.equals("射灯打开")) {
						ControlUtils.control(ConstantUtil.Lamp,
								ConstantUtil.CHANNEL_ALL, ConstantUtil.OPEN);
					} else if (v1.equals("温度") && v2.equals("<=")
							&& temp <= fazhi && v3.equals("风扇打开")) {
						ControlUtils.control(ConstantUtil.Fan,
								ConstantUtil.CHANNEL_ALL, ConstantUtil.OPEN);
					} else if (v1.equals("光照") && v2.equals(">") && ill > fazhi
							&& v3.equals("射灯打开")) {
						ControlUtils.control(ConstantUtil.Lamp,
								ConstantUtil.CHANNEL_ALL, ConstantUtil.OPEN);
					} else if (v1.equals("光照") && v2.equals(">") && ill > fazhi
						...
						ControlUtils.control(ConstantUtil.Fan,
								ConstantUtil.CHANNEL_ALL, ConstantUtil.OPEN);
					} else if (v1.equals("光照") && v2.equals("<=")
							&& ill <= fazhi && v3.equals("射灯打开")) {
						ControlUtils.control(ConstantUtil.Lamp,
								ConstantUtil.CHANNEL_ALL, ConstantUtil.OPEN);
					} else if (v1.equals("光照") && v2.equals("<=")
							&& ill <= fazhi && v3.equals("风扇打开")) {
						ControlUtils.control(ConstantUtil.Fan,
								ConstantUtil.CHANNEL_ALL, ConstantUtil.OPEN);
					}
				}
