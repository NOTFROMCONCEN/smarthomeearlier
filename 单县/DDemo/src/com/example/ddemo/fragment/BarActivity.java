...
import com.example.ddemo.R.id;
import com.example.ddemo.R.layout;
import com.example.ddemo.R.menu;
import com.example.ddemo.R.string;
...
public class BarActivity extends FragmentActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		actionBar.addTab(actionBar.newTab().setText("联动控制")
				.setTabListener(this));
		actionBar.addTab(actionBar.newTab().setText("模式功能")
				.setTabListener(this));
