...
import com.example.ademo.activity.RoomDrawActivity;
import com.example.ademo.sql.MyDataBaseHelper;

public class DrawActivity extends Fragment implements OnClickListener {
	...
	public void onClick(View v) {
		...
		case R.id.line_8101:
			...
			startActivity(new Intent(getActivity(), RoomDrawActivity.class));
			break;
		case R.id.line_8102:
