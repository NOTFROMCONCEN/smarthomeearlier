...
public class MainActivity<Button, Switch> extends Activity {
	private int         count;
...
//		ID_select=(Spinner)findViewById(R.id.spinner1);
		...
		popwindow.setEdit_IP(SocketThread.SocketIp);
		popwindow.setEdit_port(SocketThread.Port);
//		adapter=new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item, ID_name);
//		ID_select.setAdapter(adapter);
//		ID_select.setOnItemSelectedListener(new OnItemSelectedListener() {
//			@Override
//			public void onItemSelected(AdapterView<?> arg0, View arg1,
//					int arg2, long arg3) {
//				// TODO Auto-generated method stub
//				adapter_text.setText(ID_name[arg2]);
//				
//				
//			}
//
...
//			
//		});
//		ID_select.setVisibility(adapter_text.VISIBLE);
